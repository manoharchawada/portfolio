    ...
    <section id="contact" className="relative scroll-mt-24 py-24 sm:py-32">
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        <SectionHeader
          ...
          description="Open to React Native, Frontend, and Full Stack roles, contract opportunities, and innovative product development. The fastest way to reach me is via email."
        />
